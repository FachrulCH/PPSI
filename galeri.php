...
$target_dir_medium = "_gambar/galeri/m/";
$target_file_medium = $target_dir_medium . basename($_FILES["filedata"]["name"]["medium"]);
...
$upload_medium = move_uploaded_file($_FILES["filedata"]["tmp_name"]["medium"], $target_file_medium);
