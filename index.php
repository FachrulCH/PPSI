...
?>
	<article role="main" class="ui-content">
            <div class="multiple-items">
                <div><a href="<?= URLSITUS ?>trip_view.php?id=110" data-ajax="false" data-transition="flip"><img src="_gambar/galeri/fit/masjid-jawa-tengah.jpg"/><div class="caption">Wisata religi di Jawa Tengah</div></a></div>
                <div><a href="<?= URLSITUS ?>trip_view.php?id=110" data-ajax="false" data-transition="flip"><img src="_gambar/galeri/fit/air-terjun-gitgit-bal.jpg"/><div class="caption">Segarnya Air Terjun</div></a></div>
                <div><a href="<?= URLSITUS ?>trip_view.php?id=110" data-ajax="false"><img src="_gambar/galeri/fit/anak-band.jpg"/><div class="caption">Festival musik indie heroes 2015</div></a></div>
            ...
            <div class="ui-grid-b" style="font-family: cursive;">
                <div class="ui-block-a"><div class="ketengah" style=" background-color: rgb(23, 186, 173); min-height:140px;margin: 5px;">
                        <a href="<?= URLSITUS ?>trip_new.php" data-ajax="false"><p class="judul">Rencanakan liburanmu</p><img src="css/images/calendar_64px.png"/></a></div></div>
            ...
            <ul data-role="listview" data-inset="true">
                <li><a href="#"><img src="_gambar/galeri/thumb/bajak.jpg" class="ui-li-thumb"/>
                        <h3>Judul Trip ini</h3>
                        <p>Bekasi, jawa barat</p>
                        <p class="ui-li-aside">Wisata alam</p>
                    </a></li>
                <li><a href="#"><img src="_gambar/galeri/thumb/dancer-on-the-stage.jpg" class="ui-li-thumb"/>
                        <h3>Judul Trip ini</h3>
                        <p>Jakarta timur, DKI Jakarta</p>
                        <p class="ui-li-aside">Wisata Kota</p>
                    </a></li>
                <li><a href="#"><img src="_gambar/galeri/thumb/air-terjun-gitgit-bal.jpg" class="ui-li-thumb"/>
                        <h3>Judul Trip ini</h3>
                        <p>Bogor, Jawa barat</p>
                        <p class="ui-li-aside">Wisata Hiburan</p>
                    </a></li>
                    <li><a href="#"><img src="_gambar/galeri/thumb/3dloveheart-wide.jpg" class="ui-li-thumb"/>
                        <h3>Judul Trip ini</h3>
                        <p>Tanggerang, Banten</p>
                        <p class="ui-li-aside">Wisata Keluarga</p></a></li>
                <li><a href="#"><img src="_gambar/galeri/thumb/wild-poppies.jpg" class="ui-li-thumb"/>
                        <h3>Judul Trip ini</h3>
                        <p>Bekasi, jawa barat</p>
                        <p class="ui-li-aside">Wisata alam</p>
                    </a></li>
