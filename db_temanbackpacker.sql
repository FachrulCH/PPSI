...
select a.trip_id, a.trip_judul, a.trip_tujuan_provinsi, 
(SELECT b.param_name FROM v_param_parent b where b.param_id = a.trip_kategori) AS param_name, 
a.trip_created_date, (select c.galeri_foto_url from tb_galeri c where (c.galeri_trip_id = a.trip_id) order by rand() limit 0,1) AS trip_gambar 
from tb_trip a order by a.trip_created_date desc;